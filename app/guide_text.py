...
- osm_paths/           … pěšiny z OpenStreetMap (ODbL) – geojson + shapefile OSM_cesty (po dedupu i do KP PNG); na sprintu i chodníky (footway=sidewalk); studny/prameny, mokřad, jeskyně, hřiště/sportoviště; volitelně lavičky / lampy / herní prvky; při prioritě OSM (hlavně sprint) ploty/zdi/brány/…
